package com.vluk4.translatify.core.presentation

import androidx.annotation.DrawableRes
import com.vluk4.translatify.R
    ...
    actual companion object {
        actual fun byCode(langCode: String): UiLanguage {
            return allLanguages.find { it.language.langCode == langCode }
                ?: throw java.lang.IllegalArgumentException("Invalid or unsupported language code")
        }
